...
- 002-rail-baron-engine: Added C# 12 on .NET 8 (LTS) + .NET base class libraries, existing Boxcars solution projects, ASP.NET Core-compatible interfaces for host integration
