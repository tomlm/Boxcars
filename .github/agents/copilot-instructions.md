...
- C# 12 on .NET 8 (`net8.0`) + ASP.NET Core Blazor Server, MudBlazor, ASP.NET Core SignalR, ASP.NET Core Identity (custom store), Azure.Data.Tables (001-port-ui-mudblazor)
